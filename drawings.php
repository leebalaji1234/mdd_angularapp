...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" ng-app="md">
<head>
...
box-shadow:inset 22px 22px 22px 22px #ffffff;">
 ...
 <?php if($_SESSION['drawing']['error'] ==1) {
	...
	<div class="section"  >
      ...
      <div class="col-md-10">
        <div class="btn-group">
          ...
          <a href="#" class="filters btn btn-success" onclick="$('.filters').removeClass('active');" ng-click="sort('created'); resetcache()">Most Recents  <i class="fa fa-icon fa-arrow-down" ng-if="reverse == true"></i> </a> 
    ...
    margin-right: 109px;
    margin-top: 6px !important;" ng-click="onSkipSponsor()" >Just want to be a part of this innovation >> </a>
