 ...
 <div class="panel panel-default">
              ...
              <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input  name="first_name" size="20" class="form-control" placeholder="First name here ..." value="{$smarty.request.first_name|escape}" />
                    </div>
                  </div>
                  ...
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input  name="last_name" size="20" class="form-control" placeholder="Last name here ..." value="{$smarty.request.last_name|escape}" />
                    </div>
                  </div>
                <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input  name="email"  size="80" class="form-control" placeholder="Enter email ..." value="{$smarty.request.email|escape}" />
                    </div>
                  </div>
                  ...
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input  name="email_confirm" size="80"  class="form-control" placeholder="Confirm email ..." value="{$smarty.request.email_confirm|escape}" />
                    </div>
                  </div>
                  ...
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input type="password" name="pass" size="20" class="form-control pass_field" placeholder="password here ..." value="{$smarty.request.pass|escape}"  />##(Must be at least 8 characters long)##
                    </div>
                  </div>
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                      <input type="password" name="pass_confirm" size="20" class="form-control pass_conf_field" placeholder="confirm password here ..." value="{$smarty.request.pass_confirm|escape}"  />##(Must be at least 8 characters long)##
                    </div>
                  </div>
                   <!-- dob 
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-5">  
                     <input name="dob"   id="inputDate" class="form-control inputDate dobfield" placeholder="mm/dd/YYYY"  value="01/01/2016" readonly="readonly" onchange="ajaxCallToCreateAge(this.value);"   />
                  ...
                  <div class="col-sm-10 col-sm-offset-2">   
                   <div class="col-sm-2">
                      <label for="inputDate" class="control-label">## Day##</label>
                                   
                     <select name="day" id="day"  class="form-control" onchange="appendTodob();" >
                      
                        {foreach key = k item=day from=$days}
                        <option  value='{$day}'  >{$day} </option>
                        {/foreach}
                      </select>
                     </div> 
                      <div class="col-sm-2">
                      <label for="inputDate" class="control-label">## Month##</label>
                      <select name="month"  id="month" class="form-control" onchange="appendTodob();" >
                      
                        {foreach key=month item=val from=$months}
                        <option  value='{$month}'  >{$val} </option>
                        {/foreach}
                      </select>
                      </div>
                       <div class="col-sm-2">
                      <label for="inputDate" class="control-label">## Year##</label>
                      <select name="year"  id="year" class="form-control" onchange="appendTodob();" >
                  ...
                  <div class="form-group required">
                     <div class="col-md-2">
                      ...
                      <!-- {if $smarty.request.country == $country->id} selected='selected' {/if}-->
                    </div>
                  </div>
                  <div class="form-group required">
                     <div class="col-md-2">
