...
<div class="row">
          ...
          <div class="col-md-12" >
            <div class="panel panel-default">
              ...
              <div class="panel " style="  min-height: 752px;">
   ...
   <p id="pic_error2" style="display:none; color:#FF0000;">Max file size should be 2MB.</p>
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-8">  
                      <select name="theme_id" id="theme1" class="form-control" onchange="showThemeDesc(this.value);" > 
                     ...
                     <!-- div for theme description enable -->
          
           <!-- div theme desc close -->
                  </div>
                  ...
                  <div class="form-group parent_placeholder required" style="display:{$parentdisplay == 'enable'?'block':'none'};">
                    <div class="col-sm-4">
                      <label for="dob1" class="control-label">##  Parent Name##</label>
                    </div>
                    <div class="col-sm-8">  
                  ...
                  <div class="form-group parent_placeholder required" style="display:{$parentdisplay == 'enable'?'block':'none'};">
                    <div class="col-sm-4">
                      <label for="dob1" class="control-label">## Parent Details##</label>
                    </div>
                    <div class="col-sm-8">  
...
{/if} -->
              ...
              <div id="newyrt" class="col-md-5" style="
    ">
    <div class="panel panel-default">
    <div class="panel-heading">
                <span class="text-primary"> <strong>Theme Description </strong> </span>
              </div>
          <p class="text-primary" id="theme_desc" style="display:none; "></p>
          </div>
          </div>
          </div>
            </div>
