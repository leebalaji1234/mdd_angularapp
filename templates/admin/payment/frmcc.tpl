<p>
  <strong>##Split Credit Card E-Mail Address##</strong><br />
  ...
  <input type="text" name="configuration[MODULE_PAYMENT_CC_EMAIL]" value="{$paymod_data.MODULE_PAYMENT_CC_EMAIL|escape}" size="40" />
</p>
