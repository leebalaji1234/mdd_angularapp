...
" />
<?php endif;  if ($this->_tpl_vars['meta_robots']): ?>
...
" />
<?php endif;  $_from = $this->_tpl_vars['stylesheets']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" />
<?php endforeach; endif; unset($_from);  if ($this->_tpl_vars['app']->setting->rss_latest_pixels > 0): ?>
...
" />
<?php endif;  if ($this->_tpl_vars['app']->setting->rss_top_pixels > 0): ?>
...
" />
<?php endif;  if ($this->_tpl_vars['app']->setting->rss_blog_articles > 0): ?>
...
" />
<?php endif;  $_from = $this->_tpl_vars['scripts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
