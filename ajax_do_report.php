...
require_once('drawing_report.class.php'); 
 ...
 if(isset($_POST) && $_POST['name'] && $_POST['email']){
 	 ...
 	 $tbl_reports->ip = $_SERVER['REMOTE_ADDR'];
 	 ...
 	 $mailContent = '';
 	 $mailContent .= "Reporter Name : ".$_POST['name'].",";
 	 $mailContent .= "Reporter Email : ".$_POST['email'].",";
 	 $mailContent .= "Issue Type : ".$_POST['issue_type'].",";
 	 $mailContent .= "Issue : ".$_POST[$_POST["issue_type"].'_issue'].",";
 	 if(isset($_POST['additional_details']) && $_POST['additional_details'] !=''){
 	 	$mailContent .= "More Detail".$_POST['additional_details'];
 	 }
